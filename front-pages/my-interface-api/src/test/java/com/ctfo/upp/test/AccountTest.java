...
public class AccountTest extends TestBase {
	...
	public void createAccount() {
		try {
			...
			mpParas.put("mobileNo", "13682222222");
			mpParas.put("ownerLoginName", "中交支出");
			mpParas.put("accountType", "0");
			mpParas.put("ownerUserId", "f2e6a22p-950c-4135-a298-d0a2c25b387b");
...
//			parameter.setEqual(mpParams);
			...
			Map<String, String> equel = new HashMap<String, String>();
			equel.put("accountType", "2");
			
			Map<String, String> startwith = new HashMap<String, String>();
			startwith.put("accountTime", "1435593600000");
			
			Map<String, String> endwith = new HashMap<String, String>();
			endwith.put("accountTime", "1435593600000");
			
			DynamicSqlParameter parameter = new DynamicSqlParameter();
			parameter.setEqual(equel);
			
			parameter.setStartwith(startwith);
			parameter.setEndwith(endwith);
	...
	@Test
	public void countAccountDetail() {
		try {
			
			//[以...条件开始:{accountTime=1435593600000}][以...条件结束:{accountTime=1435679999000}]
			Map<String, String> equel = new HashMap<String, String>();
			equel.put("accountType", "2");
			...
			Map<String, String> endwith = new HashMap<String, String>();
			endwith.put("accountTime", "1435679999000");
			...
			String url = UPP_URL + "/account/countAccountDetail";
...
//			parameter.setOrder("accountTime");
			...
			Map<String, String> endwith = new HashMap<String, String>();
			endwith.put("accountTime", "1435599600000");
	...
	public void getCashierDeductMoneyUrl() {
		try {
			Map<String, String> mpParas = new HashMap<String, String>();
			mpParas.put("accountNo", "MA1423471016772302");// 账户
			...
			mpParas.put("userId", "ea32affa-3ef1-41c7-94d-9addd9d3e7fe");// 用户id
			...
			mpParas.put("identityId", "ea32affa-3e4-41c7-962d-9addd9d3e7fe");// 标示ID
			mpParas.put("clentType", "2");// 终端类型（0IMEI，1MAC，2UUID，3其他）
			mpParas.put("clentId", "ea32affa-3ef1-41c7-962d-9addd9d3e7fe");// 终端标示ID
