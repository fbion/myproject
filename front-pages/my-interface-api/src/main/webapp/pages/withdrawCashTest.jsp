...
<hr />
	...
	<form name="form1" method="post" action="<%=root%>/upp/withdrawcashtest" id="form1" >
			...
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center">
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						<input type="text" name="userId" id="userId" value="8da7ef66-6de3-48df-af95-2976b6c47b2e"/>
					</td>
				</tr>
				<tr>
					<td align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>提现账号:</td>
					<td align="left" class="l-table-edit-td">
						<input type="text" name="AccountNo" id="AccountNo" value="MA1417084545168449"/>
					</td>
				</tr>
				<tr>
					<td align="right" class="l-table-edit-td"><span style="color: red;">*&nbsp;</span>提现金额:</td>
					<td align="left" class="l-table-edit-td">
						<input type="text" name="orderAmount" id="orderAmount" value="5"/>
					</td>
				</tr>				
				<tr>
				...
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						<input type="text" name="orderType" id="orderType" value="5"/>
					</td>
				</tr>		
