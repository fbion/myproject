...
<body style="height: 90%; padding: 20px;">
   <fieldset>
		<legend>测试查询已通过实名认证信息接口</legend>
		<form name="queryForm" method="post"
			action="<%=root %>/upp/realNameAuthenController/queryAuthenState/">
				...
				<table cellpadding="0" cellspacing="0" class="l-table-edit"
					...
					<tr>
						...
						<td align="left" class="l-table-edit-td"><input type="text"
							name="idCard" id="idCard" ltype="text" value="MA1417075872544666"
							validate="{required:true,minlength:1,maxlength:30}" /></td>
					</tr>
					<tr>
						<td colspan="5" align="center"><input type="button"
							value="查询" id="Button1"
							onclick="document.forms[0].action='<%=root %>/upp/realNameAuthenController/queryAuthenState/';document.forms[0].action=document.forms[0].action+document.getElementById('idCard').value;document.forms[0].submit();"
