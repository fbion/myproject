...
<head>
    <title>运营管理平台－支付中心－一键支付PC端外部接口测试</title>
</head>

<body style="height: 90%; padding: 20px;">
<fieldset>
<legend>一键支付PC端外部接口测试</legend>
	<form name="submitForm" method="post" action="<%=root %>/upp/fastPaymentPCController/payment">
		<div id="tableDiv" style="overflow: auto; height:360px;">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center">
				...
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						<input type="text" name="userId" id="userId" ltype="text" value="90e63c0e-f2d2-48b2-8b87-2fa1c9dd4750" validate="{required:true,minlength:1,maxlength:20}" />
					</td>
				</tr>
				...
				<tr>
					...
					<td align="left" class="l-table-edit-td">
						<input type="text" name="accountNo" id="accountNo" ltype="text" value="MAPC1001"  validate="{required:true,minlength:1,maxlength:30}" />
					</td>
				</tr>
