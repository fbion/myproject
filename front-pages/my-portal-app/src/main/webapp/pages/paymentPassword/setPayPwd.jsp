...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/pages/paymentPassword/setPayPwd.js" ></script>
</head>
<body>	
	<!--right-->
	<div class="w800 fr" style="float: left; margin: 0;padding: 0;">
		<div class="mycar">
			<div class="pub-tit">设置支付密码</div>
			<div class="pub-box pt40 pb40">
				...
				<div id="form-three" style="display: none">
					...
					<div class="account-bot-btn" id="back-home">
						<input type="button" value="返回资金账户首页">
					</div>
				</div>
			</div>
		</div>
