...
<head>
<title>线下流程管理-小票充值审批</title>
<link href="../../css/all.css" rel="stylesheet" type="text/css" />
<jsp:include page="../all_js.jsp" />
<script src="receiptRechargeDealFinal.js?v=g_version" type="text/javascript" charset="utf-8"></script>
<style type="text/css">
td{
	width:120px;
}
			...
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="left">
					...
					<tr>
						...
						<td align="left" class="l-table-edit-td" colspan="3">
							<a href="javascript:void(0)"  id="imgHref" title="点击查看大图" onclick="window.dealFinalList.showImg(0)">查看</a>
							<a href="javascript:void(0)" style="display: none;" id="imgHref" title="点击查看大图" onclick="window.dealFinalList.queryBigImg()">查看</a>
						...
						<td align="left" class="l-table-edit-td" colspan="3">
							<a href="javascript:void(0)"  id="imgHref" title="点击查看大图" onclick="window.dealFinalList.showImg(1)">查看</a>
							<a href="javascript:void(0)" style="display: none;" id="imgHref" title="点击查看大图" onclick="window.dealFinalList.queryBigImg()">查看</a>
							<img id="passImg_img"  height="40" width="40" style="cursor: pointer;display: none;"/>
						</td> 
					</tr>
					...
					<tr>
						...
						<td align="left" class="l-table-edit-td">
							<input type="radio" id="agree" name="approvalResult"  checked="checked" value="同意"/>已分配&nbsp;&nbsp;
							<input type="radio" id="disagree" name="approvalResult" value="不同意" />未分配
						</td>
