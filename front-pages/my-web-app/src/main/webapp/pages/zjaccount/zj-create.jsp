...
<script src="zj-create.js?v=g_version" type="text/javascript" charset="utf-8"></script>
</head>
				...
				<form id="queryCommonUserInfoForm">
					<table style="margin: 5px 0px 0px 61px;">
						<tr>
							...
							<td width="15%"align="left" nowrap="nowrap"><input type="button" id="submitButton" value="查询" onclick="window.zjcreate.search();" class="l-button l-button-submit" /></td>
							<td width="12%" align="left" nowrap="nowrap"><input id="queryReset" type="button" onclick="window.zjcreate.reset();" value="重置" class="l-button l-button-submit" /></td>
						</tr>
					</table>
				</form>
			</div>
