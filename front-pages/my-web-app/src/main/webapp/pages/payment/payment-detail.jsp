...
<head>
<title>线下流程管理-扣款审批详细信息</title>
<link href="../../css/all.css" rel="stylesheet" type="text/css" />
<jsp:include page="../all_js.jsp" />
<script src="payment-detail.js?v=g_version" type="text/javascript" charset="utf-8"></script>
</head>
	...
	<div id="layout1" style="width: 100%; margin: 0 auto; margin-top: 0px;">
		<div id="gridList" class="grid">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" align="left">
				...
				<tr>
					<td align="right" class="l-table-edit-td">付款类型：</td>
					<td align="left" id="payType"></td>
					<td align="right" class="l-table-edit-td">资金确认时间：</td>
					<td align="left" id="fundsConfirmTime" colspan="3"></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="right" class="l-table-edit-td">审批人：</td>
					<td align="left" class="l-table-edit-td" id="dealApprovalPersonName"></td>  
					<td align="right" class="l-table-edit-td">审批时间：</td>
					<td align="left" class="l-table-edit-td" id="dealOperTime" colspan="3"></td>
				</tr>
				<tr>
					<td align="right" class="l-table-edit-td">审批结果：</td>
					<td align="left" class="l-table-edit-td"  id="dealApprovalResult"></td>
					<td align="right" class="l-table-edit-td">审核意见或建议：</td>
					<td align="left" class="l-table-edit-td"  id="dealApprovalSuggest" colspan="3"></td>
				</tr>
				<!-- 财务经理审批 -->
				...
				<tr id="financialAgreeTr" style="display: none;">
					<td align="right" class="l-table-edit-td">审批人：</td>
					<td align="left" class="l-table-edit-td" id="financeApprovalPersonName"></td>
					<td align="right" class="l-table-edit-td">审批时间：</td>
					<td align="left" class="l-table-edit-td" id="financeOperTime"></td>
				</tr>
				<tr id="financialSuggestTr" style="display: none;">
				<td align="right" class="l-table-edit-td">审批结果：</td>
					<td align="left" class="l-table-edit-td" id="financeApprovalResult"></td>
