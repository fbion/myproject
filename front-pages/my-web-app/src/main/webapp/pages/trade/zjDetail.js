(function() {
	...
	GeneralDetail.prototype = {
		config : {
//			queryObjectUrl : root + '/zjtrade/queryList.action',
			queryObjectUrl : root + '/zjtrade/queryDetailInfo.action',
			subHeight : subHeight,
			subWidth : subWidth,
		},
		cache : {
		...
		initData : function() {
			...
			MALQ_CODE.titleBlock($('#step1'), '账户管理-中交账户流水-流水详细信息', imgUrl);
...
//					var accountSubject = obj.accountSubject;
					...
					$("#accountDate").text(getSmpFormatDateByLong(parseInt(obj.accountTime), true));//记账日期
