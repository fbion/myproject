...
var LogSet=function(){	
	this.delUrl = root + '/logmanager/deleteGatewayServiceLogs.action';	
};
...
LogSet.prototype={
	 ...
	 init:function(){
		 ...
		 MALQ_CODE.getSelectByData($('#type'), [{text:'请求',id:'1'},{text:'回调',id:'2'}],130,120);
	     $('#type').val('请选择...');	 
	 },
        ...
        //alert(handleTime);return;
		 $.ligerDialog.confirm('日志信息被删除后将不可恢复, 确定要删除吗？', function (yes){
      	   if(yes){
      		 ...
      		 var name=$('#name').val();
      		 var parms ={'name':name, 'dateStr':logTime+' 00:00:00', 'type':type};
