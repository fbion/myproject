...
<head>
    ...
    <script src="<%=root %>/js/ligerGrid.showFilter.csm.js" type="text/javascript"></script> 
      ...
      <script src="<%=root%>/js/jsonUtil.js" type="text/javascript" charset="utf-8"></script>
            
    <script src="xinShengLogGrid.js" type="text/javascript" charset="utf-8"></script>
		...
		<form id="queryForm">
			<div id="queryDiv">
				...
				<table style="top:0px;" class="l-table-edit">
					<tr>
						<td width="15%" align="right" class="l-table-edit-td">接口编号：</td>
						<td width="10%" class="l-table-edit-td"><input type="text" id="serviceCode" name="serviceCode" /></td>
						
						<td width="10%" align="right" class="l-table-edit-td">请求状态：</td>
						<td width="15%" class="l-table-edit-td"><input type="text" id="state" name="state" /></td>	
													
						<td width="15%" align="center" class="l-table-edit-td"><input id="query1" type="button" onclick="xinShengLogManager.f_search();" value="查询"  class="l-button l-button-submit"/></td>
						<td width="30%" align="left" class="l-table-edit-td"><input id="query2" type="button" onclick="xinShengLogManager.ff_search();" value="高级查询"  class="l-button l-button-submit"/></td>
