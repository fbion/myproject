...
<head>
    ...
    <script src="noticeLogGrid.js" type="text/javascript" charset="utf-8"></script>
			...
			<div id="queryDiv">
				...
				<table style="top:0px;" class="l-table-edit">
					<tr>
						...
						<td width="30%" align="left" class="l-table-edit-td"><input id="query2" type="button" onclick="log4jManager.ff_search();" value="高级查询"  class="l-button l-button-submit"/></td>
