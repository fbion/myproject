...
<head>
    ...
    <script src="webApiLogGrid.js" type="text/javascript" charset="utf-8"></script>
			...
			<div id="queryDiv">
				...
				<table style="top:0px;" class="l-table-edit">
					<tr>
						...
						<td width="10%" class="l-table-edit-td"><input type="text" id="action" name="action" /></td>
						...
						<td width="15%" align="center" class="l-table-edit-td"><input id="query1" type="button" onclick="webApiLogManager.f_search();" value="查询"  class="l-button l-button-submit"/></td>
						<td width="30%" align="left" class="l-table-edit-td"><input id="query2" type="button" onclick="webApiLogManager.ff_search();" value="高级查询"  class="l-button l-button-submit"/></td>
