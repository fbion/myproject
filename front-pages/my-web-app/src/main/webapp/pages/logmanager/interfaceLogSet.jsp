...
<head>
	...
	<script type="text/javascript" src="<%=root%>/pages/logmanager/interfaceLogSet.js" ></script>
     ...
     <div id="tableDiv" style="overflow: auto; border: 0px solid #f5f5f5;">
     	...
     	<div id="requiredDiv" style="width: 100%;"> 
     		...
     		<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center">
				...
				<tr>
					<td align="right" class="l-table-edit-td">方法:</td>
					<td align="left" class="l-table-edit-td">
						<input type="text" name="operCode" id="operCode" />
					</td>
				</tr>
