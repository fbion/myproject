...
public class SyncTradeResponse {
	...
	private String resp16_lastSuccessRecordId;
	private String resp18_exceptionDesc;
	private String hmac;
	...
	public String getResp16_lastSuccessRecordId() {
		return resp16_lastSuccessRecordId;
	}
	public void setResp16_lastSuccessRecordId(String resp16_lastSuccessRecordId) {
		this.resp16_lastSuccessRecordId = resp16_lastSuccessRecordId;
	}
	public String getResp18_exceptionDesc() {
		return resp18_exceptionDesc;
	}
	public void setResp18_exceptionDesc(String resp18_exceptionDesc) {
		this.resp18_exceptionDesc = resp18_exceptionDesc;
	}
